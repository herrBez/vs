...
\begin{enumerate}[label=$\arabic*$.]
	\item Define the small-step operational semantics of this new iterative command.point #19
...
Vengono quindi dimostrate le due implicazioni, considerando i versi
dell'implicazione separatamente.
