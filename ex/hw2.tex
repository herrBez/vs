\exercise{Esercizio 2}
    ...
    s & & \\
          ...
          $$
           ...
           \item $\boxed{\text{Passo Induttivo}: n \rightarrow n + l,
             ...
             \begin{itemize}
               \item Ipotesi Induttiva: \confSs{\wbS{b}{S}}{s} \Rar{n} $s'$ then $\B{b}' = \semfalse$
             \end{itemize}
          $$
          \begin{array}{lrr}
    \confSs{\wbS{b}{S}}{s} \Rar{} & \whileSOS & \\
    ...
    s' & & \\
          ...
          $$
             ...
             \begin{itemize}
             \item \confSs{S}{s} \Rar{n} $s''$ (ovvero $\exists l:$
               \confSs{S}{s} \Rar{l} $s''$)
             \item \confSs{\wbS{b}{S}}{s''} \Rar{*} $s'$
             \end{itemize}
             siccome la derivazione di \confSs{\wbS{b}{S}}{s''} \Rar{n} $s'$ è più
             corta di quella di partenza (\confSs{\wbS{b}{S}}{s} \Rar{n+l} $s'$)
