...
unione di catene, quindi sottoinsiemi, contenute in $P$.
	...
	(siccome $\bigcup Y$ è stato ottenuto come unione di vari insiemi).
	Ma allora dal fatto che $S$ è down-closed (per la costruzione di
	$\bigcup Y$) ottengo che $\forall y \in P. y \leq x \Rightarrow y \in S$.
