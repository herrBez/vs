...
casi di $\mathcal{B}$ pertanto
    ...
    \item $ b' \equiv a_1 > a_2$, dove $a_1, a_2 \in \aexp$. \\
      \begin{align*} 
       \B{\lnot(a_1 \leq a_2)} = 
        ...
        \end{cases} 
      \end{align*} \\ \\
      Perciò \Bext{a_1 > a_2} = \B{\lnot(a_1 \leq a_2)}. \\.
    ...
    \end{align*} \\
      Perciò \Bext{b_1 \ \Rightarrow \ b_2} =
      \B{\lnot(
        \lnot (\B{b_1} = \semtrue \land \B{b_2} = \semtrue)
        \land
        \lnot (\B{b_1} = \semfalse \land \B{b_2} = \semfalse))}.
        \\
